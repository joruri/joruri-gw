    ...
    for @title in items
      begin
        ...
        for doc in docs
          ...
          Gwbbs::Doc.where(:title_id => @title.id,:section_code=>doc.section_code).update_all(:section_code=>group.incoming_group_code, :section_name => %Q(#{group.incoming_group_code}#{group.incoming_group_name}))
