...
def centos
  ...
  system 'yum install -y http://dev.mysql.com/get/mysql-community-release-el7-5.noarch.rpm'
  ...
  unless system 'mysqladmin ping' # Not required to connect
    ...
    system %q!mysql -u root -ppass -e "GRANT ALL ON production_jorurigw.* TO joruri@localhost IDENTIFIED BY 'pass'"!
